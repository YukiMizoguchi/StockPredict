 ...
 *
 */
@Service("predictDayClient")
public class PredictDayClientImp implements HTTPClientWithBody<StockInfo, Set<StockInfo>> {

  protected static Logger logger = Logger.getLogger(PredictDayClientImp.class);

  @Value("${common.url.predictday}")
  private String uri;
