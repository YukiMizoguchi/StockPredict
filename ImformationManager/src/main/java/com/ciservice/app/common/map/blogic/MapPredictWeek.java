...
@Component("mapPredictWeek")
public class MapPredictWeek
    implements MapData<Set<StockInfo>, Set<PredictedStockInfo>, Set<StockInfo>> {

  protected static Logger logger = Logger.getLogger(MapPredictWeek.class);
  ...
  public Set<StockInfo> map(final Set<StockInfo> stockInfos,
    ...
    for (StockInfo stockInfo : stockInfos) {
      ...
      stockInfo.setPredictWeek(mapUtil.getPredict(stockInfo, resultSet));
