 ...
 *
 */
@Service("predictWeekClient")
public class PredictWeekClientImp implements HTTPClientWithBody<StockInfo, Set<StockInfo>> {

  protected static Logger logger = Logger.getLogger(PredictWeekClientImp.class);

  @Value("${common.url.predictweek}")
  private String uri;
