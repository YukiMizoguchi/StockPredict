...
@Component("mapPredictMonth")
public class MapPredictMonth
    implements MapData<Set<StockInfo>, Set<PredictedStockInfo>, Set<StockInfo>> {

  protected static Logger logger = Logger.getLogger(MapPredictMonth.class);
  ...
  public Set<StockInfo> map(final Set<StockInfo> stockInfos,
    ...
    for (StockInfo stockInfo : stockInfos) {
      ...
      stockInfo.setPredictMonth(mapUtil.getPredict(stockInfo, resultSet));
