...
public class ReNonResultStockInfoReader implements ItemReader<Set<StockInfo>> {

  protected static Logger logger = Logger.getLogger(ReNonResultStockInfoReader.class);
  ...
  public Set<StockInfo> read() throws Exception {
    ...
    try {
      ...
      final Page<StockInfo> stockInfoPage = stockInfoRepos
          .findByRsltDayChkDateBeforeAndRsltWeekChkDateBeforeAndRsltMonthChkDateBefore(
              new PageRequest(0, limit), chkDateBefore, chkDateBefore, chkDateBefore);
