...
@Component("reNonDayResultStockInfoReader")
public class ReNonDayResultStockInfoReader implements ItemReader<Set<StockInfo>> {
  ...
  public Set<StockInfo> read() throws Exception {
    ...
    try {
      ...
      final Page<StockInfo> stockInfoPage =
          stockInfoRepos.findByRsltDayChkDateBefore(new PageRequest(0, limit), chkDateBefore);
